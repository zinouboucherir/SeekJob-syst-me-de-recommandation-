...
class seeker_resume(models.Model):
    ...
    cv_education_extracted = models.TextField(blank=True, default='')
    cv_experience_extracted = models.TextField(blank=True, default='')
    cv_skills_extracted = models.TextField(blank=True, default='')
...
class Jobs(models.Model):
    ...
    job_education_extracted = models.TextField(blank=True, default='')
    job_experience_extracted = models.TextField(blank=True, default='')
    job_skills_extracted = models.TextField(blank=True, default='')

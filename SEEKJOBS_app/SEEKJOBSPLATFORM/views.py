...
from . import backend
from .forms import RegistrationForm, CompanyInformation, LoginForm, newJob, resumeUpload, SearchtitledocumentForm, \
    SearchregionForm, JobTypeFilterForm
# Create your views here.
from .models import Jobs, company, seeker_resume, recruiter, applications
...
def searchJob(request):
    ...
    return render(request=request, template_name='SEEKJOBSPLATFORM/jobs.html', context={'jobs': documents})
